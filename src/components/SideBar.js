...
const SideBar = () => {
  return (
    <div className="flex w-fit">
            <div className="flex flex-col h-screen p-6 shadow text-white side-bar">
                            ...
                            <div className='music-links py-4 px-4 my-4'>
                                ...
                                <li className="my-5">
                                    <a
                                        ...
                                        className="flex items-center p-2 space-x-3 rounded-md"
                                    >
                                        <BiRadio fontSize='2rem' color='#EFEEE040'/>
                                    </a>
                                </li>
                                <li className="my-5">
                                    <a
                                        ...
                                        className="flex items-center p-2 space-x-3 rounded-md"
                                    >
                                        <MdMusicVideo fontSize='2rem' color='#EFEEE040'/>
                                    </a>
                                </li>
                            </div>
                            
                            <div className='user-links py-4 px-4 my-4'>
                                <li className="my-5">
                                    <a
                                        href="#"
                                        className="flex items-center p-2 space-x-3 rounded-md"
                                    >
                                        <FaUser fontSize='2rem' color='#EFEEE040'/>
                                    </a>
                                </li>
                                <li className="my-5">
                                    <a
                                        ...
                                        className="flex items-center p-2 space-x-3 rounded-md"
                                    >
                                        <IoLogOut fontSize='2rem' color='#EFEEE040'/>
                                    </a>
                                </li>
                            </div>
                        </ul>
