...
const ChartCard = (props) => {
  ...
  return (
    <div
      ...
      className="flex chart-card text-white my-2 p-3 items-center"
    >
      <div className="mx-2">
        <img className="w-16 h-16" src={props.img} alt="thumbnail" />
      </div>
      ...
      <div
        className="flex justify-center items-center like-icon w-10 h-10 mx-2 cursor-default"
        onClick={(e) => {
          e.stopPropagation();
          handleLike();
        }}
